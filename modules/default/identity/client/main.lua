...
RegisterNetEvent("__zm:client:modules:indentity:register", function()
  Citizen.CreateThread(function()
    ...
    while not HasAnimDictLoaded("anim@mp_bedmid@left_var_02") do Citizen.Wait(1) end

    local loopLayInBedScene = NetworkCreateSynchronisedScene(sCoord, sRot, 2, false, true, 1065353216, 0, 1065353216)
	  NetworkAddPedToSynchronisedScene(ZMan.Cache.Ped, loopLayInBedScene, "anim@mp_bedmid@left_var_02", "f_sleep_l_loop_bighouse", 1.5, -1, 13, 16, 1148846080, 0)
    ...
    SetPedComponentVariation(ZMan.Cache.Ped, 0, 0, 0, 2)

    DisableAllControlActions(0)

    local getOutBedScene = NetworkCreateSynchronisedScene(sCoord, sRot, 2, false, false, 1065353216, 0, 1065353216)
    NetworkAddPedToSynchronisedScene(ZMan.Cache.Ped, getOutBedScene, "anim@mp_bedmid@left_var_02", "f_getout_l_bighouse", 0, -1.5, 13, 16, 1148846080, 0)
    ...
    ZMan.Callback("modules:identity:data", nil, data)
  end)
end)
