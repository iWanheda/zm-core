...
function CPlayer:GetIdentifier()
	...
	if not identifier then
		return self:Kick( ( 'There was an error getting your identifier (%s), please report this to the system administrator.' ):format( Config.Identifier ) )
	end
...
function CPlayer:SavePlayer()
	...
	MySQL.Async.execute( 'UPDATE users SET last_location = @last_location, inventory = @inv WHERE identifier = @id',
	{
